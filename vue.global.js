...
`stop,prevent,self,`   +
  ...
  */
  ...
  function createHydrationFunctions({ mt: mountComponent, o: { patchProp, createText } }) {
      ...
      const hydrateElement = (el, vnode, parentComponent, optimized) => {
          ...
          if (patchFlag !== -1 /* HOISTED */) {
              ...
              if (vnode.shapeFlag & 16 /* ARRAY_CHILDREN */ &&
                  ...
                  hydrateChildren(el.firstChild, vnode, parentComponent, optimized || vnode.dynamicChildren !== null);
              }
          }
          return el.nextSibling;
      };
      const hydrateChildren = (node, vnode, parentComponent, optimized) => {
